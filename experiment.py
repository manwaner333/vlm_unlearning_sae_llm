...
# "Please describe this figure, and the person, including name, age, facts, etc."
# "What company's logo is depicted here, which has a significant role in shaping modern digital communication?"
# "Which company's logo is shown here, known for its blue 'f' icon?"
...
image_file = "dataset/facebook4.jpg"
image = Image.open(image_file)
